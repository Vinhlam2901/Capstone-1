...
module alu (
  ...
  wire        slt, sltu;
  wire [31:0] rd_and, rd_or, rd_xor, rd_sra, rd_srl, rd_sll, rd_add, rd_sub, rd_slt, rd_sltu, rd_mul_low, rd_mul_high;
  wire        cout_add, cout_sub, rd_equals, rd_equalu;

  and_module #(.WIDTH(32)) and_module         (
                                                .rs1_i(i_op_a),
                                                .rs2_i(i_op_b),
                                                .rd_o(rd_and)
                                              ); //AND

  or_module #(.WIDTH(32)) or_module           (
                                                .rs1_i(i_op_a),
                                                .rs2_i(i_op_b),
                                                .rd_o(rd_or)
                                              ); //OR

  xor_module #(.WIDTH(32)) xor_module          (
                                                .rs1_i(i_op_a),
                                                .rs2_i(i_op_b),
                                                .rd_o(rd_xor)
                                              ); // XOR

  add_subtract #(.WIDTH(32))  subtract_module (
                                                .a_i      (i_op_a),
                                                .b_i      (i_op_b),
                                                .cin_i    (1'b1),
                                                .result_o (rd_sub),
  ...
  add_subtract #(.WIDTH(32)) add_module       (
                                                .a_i      (i_op_a),
                                                .b_i      (i_op_b),
                                                .cin_i    (1'b0),
                                                .result_o (rd_add),
