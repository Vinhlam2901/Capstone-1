module uart_rx_send_img();
  ...
  task uart_send_byte(input [7:0] data);
    ...
    begin
      ...
      $display("📡 [%0t ns] [UART RX] Da ban xong 1 Byte: %h", $time, data);
      #(BIT_PERIOD * 2); 
    end
  endtask
  ...
  initial begin
    ...
    $shm_open("wave.vcd");
    $shm_probe(uart_rx_send_img, "ASM");
    ...
    $readmemh("../01_tb/image_test/dog_correct.hex", image_buffer);
